                ...
                <div className="board1">
                    <div className="column" style={{display:"flex", justifyContent:"space-between"}}>
                        <div className="row" style={{padding:"50px"}}>
                            ...
                            <label htmlFor="voucher-phone" className="col-form-label" style={{padding:"30px 0 0 10px"}}>Tối Thiểu:</label>
                        ...
                        <div className="row" style={{padding:"50px"}}>
                            ...
                            <label htmlFor="voucher" className="col-form-label" style={{padding:"10px"}}>Đã Dùng:</label>
                            <textarea className="txt-input form-control" id="voucher"></textarea>
                        </div>
                    </div>
